        ...
        <div class="formdangnhap">
            <form action="DangNhapUser.php" method="POST" class="needs-validation" novalidate >
                ...
                <div class="custom-control custom-switch">
                    <input type="checkbox" class="custom-control-input" id="switch1" name="ckbLuaChon" value="QuanTri">
                    <label class="custom-control-label" for="switch1">Bạn là Admin hoặc Giảng viên</label>
                </div>
                <br>
...
<?php
    if (isset($_POST["btn_submit"])) {
        ...
        $ckbLuaChon = array_key_exists('ckbLuaChon', $_POST) ? $_POST["ckbLuaChon"] : null;

        $kn = mysqli_connect("localhost", "root", "", "sotay")or die("chưa kết nối");

        if($ckbLuaChon == "QuanTri")
        {
