...
<div class="container-fluid" style="margin-top:30px;">
    <div class="row">
        ...
        <div class="col-sm-10">
            <div class="container">
                <h3 style="text-align: center">THÔNG TIN TÀI KHOẢN GIẢNG VIÊN</h3>
                <hr>
                <form action="ThongTinTaiKhoanAdmin.php" class="needs-validation" method="POST" novalidate>
                    ...
                    ?>
                    <div class="row">
                        <div class="col-sm-6"><input type="text" class="form-control" placeholder="Mã giảngviên" style="pointer-events: none" value="<?php echo $row['MaGiangVien'] ?>"></div>
                        <div class="col-sm-6"><input type="text" class="form-control" placeholder="Họ tên giảng viên" style="pointer-events: none" value="<?php echo $row['HoTen'] ?>"></div>
                    </div>
                    <div class="row">
