...
<body>
    <div class="nentrang">
        <div class="formdangnhap">
            <!-- <form action="DangNhapUser.php" method="POST" class="needs-validation" novalidate >
                <img src="image/logo1.png" class="rounded">
                <h3 style="text-align: center"><b>KHOA CÔNG NGHỆ THÔNG TIN</b></h3>
                <h3 style="text-align: center"><i>Sổ tay sinh viên</i></h3>
                <span>------ &#10020; ------</span>
                <style>
                    span {
                        content:"\2724";
            ...
            <ul class="nav nav-tabs" style="display: flex; width: 100%">
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#menu1">
                        <div style="display: block">
                            <img src="image/giangvien.png" class="rounded">
                            <h5>Giảng viên</h5> 
                        </div>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#menu2" style="display: block">
                        <div style="display: block">
                            <img src="image/sinhvien.png" class="rounded">
                            <h5>Sinh viên</h5> 
                        </div>
                    </a>
                </li>
            ...
            <div class="tab-content">
                <div class="tab-pane container fade" id="menu1">
                    ...
                    <button type="submit" name="btn_submitGV" class="btn btn-outline-dark btn-lg"><b>ĐĂNG NHẬP</b></button>
                    </div>
                <div class="tab-pane container fade" id="menu2">
                    ...
                    <button type="submit" name="btn_submitSV" class="btn btn-outline-dark btn-lg"><b>ĐĂNG NHẬP</b></button>
                </div>
            </div>
            <br>
        </div>
