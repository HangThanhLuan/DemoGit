                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Tên đăng nhập" name="txtTenDangNhap" required autocomplete="off" value="<?php echo $row['MaGiangVien'] ?>">
...
<?php
    function doimatkhau()
    {
        ...
        $kn = mysqli_connect("localhost", "root", "", "sotay")or die("chưa kết nối");
        $timmatkhau = "select MatKhau from giangvien where MaGiangVien = '".$MaSV."' and MatKhau = '".$txtMatKhauCu."'";
